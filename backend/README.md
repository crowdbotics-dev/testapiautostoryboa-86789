...
## Project Structure
    ...
    ├── testapiautostoryboa_86789  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_86789`
...
2. Clone this repo and `cd testapiautostoryboa_86789`
